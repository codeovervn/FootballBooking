...
<title>Trang Cập Nhật Sân Vận Động</title>
</head>
<body>
<div align="center">
        <h1>Add/Edit Stadium</h1>
        <form:form action="saveStadiums" method="post" modelAttribute="stadiums">
        <table>
            <%-- <form:hidden path="id"/> --%>
            <tr>
                <td style="text-align: right;">Mã Sân:</td>
                <td><form:input path="masan" placeholder="MYDINH"/></td>
            </tr>
            <tr>
                <td style="text-align: right;">Tên Sân:</td>
                <td><form:input path="tensan" placeholder="Mỹ Đình"/></td>
            </tr>
            <tr>
